...
class CreatePaymentForOrderService
{
    public function execute(
        ...
        if($paymentStat == 'completed' || $paymentMethod == 'cod') {
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                ...
                                                                                                                foreach ($order_products as $key => $value) {
                                                                                                                    if($value->discount_percent != 0) {
                                                                                                                        $body .= '<tr>
                                                                                                                            ...
                                                                                                                            <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0639;'.number_format(((float) ($value->price * 1.05) - ((($value->price * 1.05) / 100) * $value->discount_percent) * $value->qty), 3, '.', '').'</div>
                                                                                                                            </td>
                                                                                                                        </tr>';
                                                                                                                        ...
                                                                                                                        $body .= '<tr>
                                                                                                                            ...
                                                                                                                            <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0639;'.number_format(((float) ($value->price * 1.05) - ((($value->price * 1.05) / 100) * $value->sale_price) * $value->qty), 3, '.', '').'</div>
                                                                                                                            </td>
                                                                                                                        </tr>';
                                                                                                                      } else {
                                                                                                                        $body .= '<tr>
                                                                                                                        ...
                                                                                                                        <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                            <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0639;'.number_format(((float) ($value->price * 1.05) * $value->qty), 3, '.', '').'</div>
                                                                                                                        </td>
                                                                                                                        </tr>';
                                                                                                                      }
                                                                                                                }
                                                                                                                ...
                                                                                                                $body .= '<tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border-width:4px 1px 1px 1px;border-style:solid;border-color:#E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0639;'.number_format((float) ($order->sub_total), 3, '.', '').'</div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">
                                                                                                                            '.($order->shipping_amount == '0.00' ? 'You Got Free Shipping' : number_format((float) ($order->shipping_amount * 1.05), 3, '.', '')).'&#x0631;&#x002E;&#x0639;
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0639;'.number_format((float) ($order->amount), 3, '.', '').'
                                                                                                                            <small style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                                <div style="text-align:left;">(includes &#x0631;&#x002E;&#x0639;'.number_format(((float) $order->tax_amount), 3, '.', '').' VAT)</div>
                                                                                                                            </small>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="text-align:left;vertical-align:top;width:50%;">
                                                                                                                    ...
                                                                                                                    <address style="color:#636363;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;padding:12px;border:1px solid #E5E5E5;">'.$billing_data->name.'<br> '.$billing_data->address.'<br>'.$billing_data->state.'<br>'.$billing_data->city.'<br>
                                                                                                                        <span style="color:#C7944B;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                            <u>
                                                                                                                                 <a style="color:#C7944B;" href="" title="tel:+968'.$billing_data->phone.'">+968'.$billing_data->phone.'</a>
                                                                                                                            </u>
                                                                                                                        </span><br>
                                                                                                                ...
                                                                                                                <td style="text-align:left;vertical-align:top;width:50%;">
                                                                                                                    ...
                                                                                                                    <address style="color:#636363;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;padding:12px;border:1px solid #E5E5E5;">'.$shipping_data->name.'<br> '.$shipping_data->address.'<br>'.$shipping_data->state.'<br>'.$shipping_data->city.'<br>
                                                                                                                        <span style="color:#C7944B;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                            <u>
                                                                                                                                <a style="color:#C7944B;" href="" title="tel:+968'.$shipping_data->phone.'">+968'.$shipping_data->phone.'</a>
                                                                                                                            </u>
                                                                                                                        </span><br>
                                                                                                                        <span style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
            ...
            // if($order->amount >= 25 || $order->amount >= 25.00 || $order->amount >= 25.000) {
            ...
            //     $mail2->Subject = 'Congratulations You Have Entered Raffle Draw';
                ...
                //                                                                                                 <h4 style="text-align:center;display:block;margin:0 0 18px 0;line-height:150%;">Winners will be selected at random and will be notified via our social media platform on 5th April 2025.</h4>
