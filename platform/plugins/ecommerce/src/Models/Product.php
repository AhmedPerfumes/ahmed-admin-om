...
class Product extends BaseModel
{
    ...
    protected $casts = [
        ...
        'top_note' => SafeContent::class,
        'top_note_ar' => SafeContent::class,
        'top_note_image' => SafeContent::class,
        'top_note_description' => SafeContent::class,
        'top_note_description_ar' => SafeContent::class,
        'heart_note' => SafeContent::class,
        'heart_note_ar' => SafeContent::class,
        'heart_note_image' => SafeContent::class,
        'heart_note_description' => SafeContent::class,
        'heart_note_description_ar' => SafeContent::class,
        'base_note' => SafeContent::class,
        'base_note_ar' => SafeContent::class,
        'base_note_image' => SafeContent::class,
        'base_note_description' => SafeContent::class,
        'base_note_description_ar' => SafeContent::class,
        'sale_type' => 'int',
        'start_date' => 'datetime',
        'end_date' => 'datetime',
